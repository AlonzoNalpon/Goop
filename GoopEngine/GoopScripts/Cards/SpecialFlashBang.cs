...
namespace GoopScripts.Cards
{
  internal class SpecialFlashBang : CardBase
  {
    ...
    \param cardID
      ID of the card 
    ************************************************************************/
    public SpecialFlashBang(CardID cardID, CardType cardType, string animSprite) : base(cardID, cardType, animSprite)
    {
      Value = 0.5f;
      Duration = 3;
    }
    ...
    ************************************************************************/
    ...
    {
      source.m_buffs.AddBuff(new Buff(Buff.BuffType.MULTIPLY_ATK_DEALT, 0.5f, 2, "Blinded"));
    }
  }
}