...
void GE::EditorGUI::EditorTheme::SetImGuiTheme()
{
  ...
  colors[ImGuiCol_Tab] = ImVec4(0.6f, 0.f, 0.f, 1.00f); // the tab when it's not active
  colors[ImGuiCol_TabHovered] = ImVec4(0.f, 1.0f, 0.f, 0.80f); // the tab when it's hovered on
  colors[ImGuiCol_TabActive] = ImVec4(0.f, 0.65f, 0.18f, 1.00f); // the tab when it's active

  colors[ImGuiCol_TabUnfocused] = ImVec4(1.f, 0.10f, 0.10f, 1.00f);
