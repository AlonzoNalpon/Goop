...
#include <GLApp/Graphics/Texture.h>
namespace Graphics {
  /*!
   * \struct SpriteData
   * \brief  
  ...
  struct SpriteData {
    ...
    Vec2    texCoords;    //!< texture coordinates of sprite (important for tex atlas)
    Ivec2   dimensions;   //!< integral texture dimensions in width and height (x and y)
  };
}
