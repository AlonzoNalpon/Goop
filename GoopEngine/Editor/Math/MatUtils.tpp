...
{
  mtx[0] = dMat3::ValueType(1.0, 0.0, 0.0);
  mtx[1] = dMat3::ValueType(0.0, 1.0, 0.0);
  mtx[2] = dMat3::ValueType(0.0, 0.0, 1.0);
}
...
{
  mtx[0] = dMat3::ValueType(x, 0.0, 0.0);
  mtx[1] = dMat3::ValueType(0.0, y, 0.0);
  mtx[2] = dMat3::ValueType(0.0, 0.0, 1.0);
}
...
void MtxRotate(dMat3& mtx, float radians)
{
  ...
  mtx[0] = dMat3::ValueType(cosRad, -sinRad, 0.0);
  mtx[1] = dMat3::ValueType(sinRad, cosRad, 0.0);
  mtx[2] = dMat3::ValueType(0.0, 0.0, 1.0);
}
...
{
  mtx[0] = dMat3::ValueType(0.0, 0.0, x);
  mtx[1] = dMat3::ValueType(0.0, 0.0, y);
  mtx[2] = dMat3::ValueType(0.0, 0.0, 1.0);
}
